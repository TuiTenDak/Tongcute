    ...
    <section class="position-relative bg-info overflow-hidden py-5">
        <div class="container position-relative z-2 pb-2 py-sm-4 py-md-5 my-xxl-4">
            <div class="mx-auto py-lg-4 py-xl-5" style="max-width: 630px">
                <h1 class="display-4 text-white text-center pb-2 pb-md-0 mb-4 mb-md-5">Khám bệnh tại nhà. Tại sao không?</h1>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 p-1">
                        <div class="d-flex flex-column flex-sm-row w-100 gap-2 gap-sm-3">
                            <div class="position-relative w-100">
                                ...
                                <input type="search" class="form-control form-control-lg form-icon-start border-0 rounded-0 pe-0" placeholder="Tìm dịch vụ mà bạn muốn..." required="">
                            </div>
                ...
                <div class="d-flex flex-wrap justify-content-center gap-2 pt-2 pt-md-0">
                    <button type="button" class="btn btn-outline-light rounded-pill mt-1 me-1">Sức khỏe sinh sản</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mt-1 me-1">Tiểu đường thai kỳ</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mt-1 me-1">Chăm sóc người gầy</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mt-1 me-1">Tổng quát</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mt-1 me-1">Kiểm tra chức năng gan</button>
                </div>
            </div>
        </div>
...
<!--            <img src="/thesixhospital/assets/img/home/contractors/hero.png" alt="Image">-->
    ...
    <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 mb-xxl-3">
        <div class="d-flex align-items-start justify-content-between gap-4 pt-5 pb-3 mb-2 mb-sm-3 mb-lg-4">
            <h2 class="mb-0">Khám bệnh theo chuyên khoa</h2>
            <div class="nav">
                <a class="nav-link position-relative fs-base text-nowrap py-1 px-0" href="#!">
                    <span class="hover-effect-underline stretched-link me-1">Xem tất cả</span>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3 g-sm-4">
            ...
            <div class="col">
                <article class="hover-effect-scale position-relative d-inline-flex align-items-center gap-3">
                    ...
                    <h3 class="h6 fw-normal mb-0">
                        <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Flooring</a>
                    </h3>
                </article>
            </div>
            ...
            <div class="col">
                <article class="hover-effect-scale position-relative d-inline-flex align-items-center gap-3">
                    <div class="position-relative d-flex align-items-center justify-content-center text-secondary-emphasis" style="width: 56px; height: 56px">
                        <svg class="position-relative z-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"><path d="M22.105 0H5.407a1.17 1.17 0 0 0-1.171 1.171v1.511h-1.14C1.788 2.682.724 3.746.724 5.055v3.486c0 1.309 1.065 2.373 2.373 2.373h8.273c1.05 0 1.904.854 1.904 1.904v.617h-1.663c-.296 0-.536.24-.536.536v2.145c0 .296.24.536.536.536h.134v5.336c0 1.109.902 2.011 2.011 2.011s2.011-.902 2.011-2.011v-5.336h.134c.296 0 .536-.24.536-.536v-2.145c0-.296-.24-.536-.536-.536h-1.555v-.617a2.98 2.98 0 0 0-2.976-2.976H3.097c-.717 0-1.301-.583-1.301-1.301V5.055c0-.717.583-1.301 1.301-1.301h1.14v1.511a1.17 1.17 0 0 0 1.171 1.171h8.027v2.333c0 .872.71 1.582 1.582 1.582h.778a.51.51 0 0 1 .509.51v.161c0 .872.71 1.582 1.582 1.582h.751c.872 0 1.582-.71 1.582-1.582v-.563a.51.51 0 0 1 .51-.509c.872 0 1.582-.71 1.582-1.582V6.417c.548-.098.965-.577.965-1.152V1.171C23.276.525 22.75 0 22.105 0zm-7.41 21.989a.94.94 0 0 1-.938.939.94.94 0 0 1-.939-.939v-5.336h1.877v5.336zm.67-7.482v1.073h-.134-2.95-.134v-1.073h3.218zm5.873-6.141a.51.51 0 0 1-.509.509c-.872 0-1.582.71-1.582 1.582v.563a.51.51 0 0 1-.509.509h-.751a.51.51 0 0 1-.509-.509v-.161-1.743c0-.296-.24-.536-.536-.536s-.536.24-.536.536v.246a1.56 1.56 0 0 0-.509-.085h-.778a.51.51 0 0 1-.51-.509V6.436h6.731v1.931h0zm.965-3.102c0 .054-.044.098-.098.098H5.407c-.054 0-.098-.044-.098-.098V1.171c0-.054.044-.098.098-.098h16.697c.054 0 .098.044.098.098v4.094h0zm-2.883-3.23a.54.54 0 0 0-.759 0c-.21.209-.209.549 0 .758l1.609 1.609c.105.105.242.157.379.157a.53.53 0 0 0 .379-.157c.21-.209.21-.549 0-.758L19.32 2.034zm-2.994 0a.54.54 0 0 0-.759 0c-.21.209-.209.549 0 .758l1.609 1.609c.105.105.242.157.379.157s.274-.052.379-.157c.21-.209.21-.549 0-.758l-1.609-1.609zm-2.994 0c-.21-.209-.549-.209-.758 0s-.209.549 0 .758l1.609 1.609c.105.105.242.157.379.157a.53.53 0 0 0 .379-.157c.21-.209.21-.549 0-.758l-1.609-1.609zm-2.994 0a.54.54 0 0 0-.759 0c-.21.209-.209.549 0 .758l1.609 1.609c.105.105.242.157.379.157s.274-.052.379-.157c.209-.209.209-.549 0-.758l-1.609-1.609zm-2.995 0c-.209-.209-.549-.209-.758 0s-.209.549 0 .758l1.609 1.609c.105.105.242.157.379.157s.274-.052.379-.157c.21-.209.21-.549 0-.758L7.343 2.034z"></path></svg>
                        <span class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 bg-body-secondary rounded-circle" style="--fn-transform-scale: 1.1"></span>
                    </div>
                    <h3 class="h6 fw-normal mb-0">
                        <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Painting</a>
                    </h3>
                </article>
            </div>
            ...
            <div class="col">
                <article class="hover-effect-scale position-relative d-inline-flex align-items-center gap-3">
                    ...
                    <h3 class="h6 fw-normal mb-0">
                        <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Plumbing</a>
                    </h3>
                </article>
            </div>
...
<!--                                <img src="/thesixhospital/assets/img/home/contractors/banner.png" alt="Image">-->
            ...
            <div class="col-lg-8">
                <div class="d-flex align-items-start justify-content-between gap-4 pb-2 mb-3 mb-lg-4">
                    <h2 class="mb-0">Đội ngũ bác sĩ</h2>
                    <div class="nav">
                        <a class="nav-link position-relative fs-base text-nowrap py-1 px-0" href="#!">
                            <span class="hover-effect-underline stretched-link me-1">Xem tất cả</span>
                            <i class="fi-chevron-right fs-lg"></i>
...
<!--                                    <img src="/thesixhospital/assets/img/home/contractors/projects/th01.jpg" alt="Image">-->
                            ...
                            <div class="pt-1 ps-3">
                                <h3 class="h6 mb-1">
                                    <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Decks &amp; porches</a>
                                </h3>
...
<!--                                    <img src="/thesixhospital/assets/img/home/contractors/projects/th02.jpg" alt="Image">-->
                            ...
                            <div class="pt-1 ps-3">
                                <h3 class="h6 mb-1">
                                    <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Roof repair</a>
                                </h3>
                                <div class="d-flex align-items-center gap-1 mb-1">
                                    <i class="fi-star-filled text-warning"></i>
...
<!--                                    <img src="/thesixhospital/assets/img/home/contractors/projects/th03.jpg" alt="Image">-->
                            ...
                            <div class="pt-1 ps-3">
                                <h3 class="h6 mb-1">
                                    <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Appliance repair</a>
                                </h3>
                                <div class="d-flex align-items-center gap-1 mb-1">
                                    <i class="fi-star-filled text-warning"></i>
...
<!--                                    <img src="/thesixhospital/assets/img/home/contractors/projects/th04.jpg" alt="Image">-->
                            ...
                            <div class="pt-1 ps-3">
                                <h3 class="h6 mb-1">
                                    <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Gutter service</a>
                                </h3>
                                <div class="d-flex align-items-center gap-1 mb-1">
                                    <i class="fi-star-filled text-warning"></i>
...
<!--                                    <img src="/thesixhospital/assets/img/home/contractors/projects/th05.jpg" alt="Image">-->
                            ...
                            <div class="pt-1 ps-3">
                                <h3 class="h6 mb-1">
                                    <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Home cleaning</a>
                                </h3>
                                <div class="d-flex align-items-center gap-1 mb-1">
                                    <i class="fi-star-filled text-warning"></i>
...
<!--                                    <img src="/thesixhospital/assets/img/home/contractors/projects/th06.jpg" alt="Image">-->
                            ...
                            <div class="pt-1 ps-3">
                                <h3 class="h6 mb-1">
                                    <a class="hover-effect-underline stretched-link" href="listings-contractors.html">Fence repair</a>
                                </h3>
                                <div class="d-flex align-items-center gap-1 mb-1">
                                    <i class="fi-star-filled text-warning"></i>
                                    <span class="fs-sm text-secondary-emphasis">4.8</span>
...
<!--                                <img src="/thesixhospital/assets/img/home/contractors/advice/01.jpg" alt="Image">-->
                        ...
                        <div class="ps-3 ps-sm-4 pe-lg-4 pe-xxl-5">
                            ...
                            <h3 class="h5 pt-1 my-2">
                                <a class="hover-effect-underline stretched-link" href="#!">Expert advice from masters of cleanliness</a>
                            </h3>
                            <p class="mb-2">Unlock the secrets to a spotless home with tips from cleaning professionals. From tackling stubborn...</p>
...
<!--                                <img src="/thesixhospital/assets/img/home/contractors/advice/02.jpg" alt="Image">-->
                        ...
                        <div class="ps-3 ps-sm-4 pe-lg-4 pe-xxl-5">
                            ...
                            <p class="mb-2">Learn the fastest and most effective methods to clean laminate flooring without damaging its surface...</p>
...
<!--                                <img src="/thesixhospital/assets/img/home/contractors/advice/03.jpg" alt="Image">-->
                        ...
                        <div class="ps-3 ps-sm-4 pe-lg-4 pe-xxl-5">
                            ...
                            <h3 class="h5 pt-1 my-2">
                                <a class="hover-effect-underline stretched-link" href="#!">Choose air conditioner with air ionization</a>
                            </h3>
                            <p class="mb-2">Explore the benefits of air conditioners with air ionization technology. Find out how these units improve air...</p>
...
<!--                                <img src="/thesixhospital/assets/img/home/contractors/advice/04.jpg" alt="Image">-->
                        ...
                        <div class="ps-3 ps-sm-4 pe-lg-4 pe-xxl-5">
                            ...
                            <h3 class="h5 pt-1 my-2">
                                <a class="hover-effect-underline stretched-link" href="#!">Landscaping ideas from top local experts</a>
                            </h3>
                            <p class="mb-2">Get inspired by creative landscaping ideas from the best local experts. Whether you're revamping your garden...</p>
        ...
        <div class="container position-relative z-2 py-lg-5">
            <div class="row py-2 py-sm-4 py-lg-5">
                <div class="col-md-4 col-lg-5 py-lg-2 py-xl-4 py-xxl-5 mb-md-3">
                    <h2 class="text-white text-center text-md-start pb-2 pb-sm-3">Grow your business with us. Become a Pro today</h2>
...
<!--                            <img src="/thesixhospital/assets/img/home/contractors/projects/04.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">-->
                        ...
                        <div class="col-sm-8 card-body d-flex flex-column align-items-start p-3 p-sm-4">
                            <h3 class="h6 mt-1 mt-sm-0 mb-2">
                                <a class="stretched-link hover-effect-underline" href="listings-contractors.html">Cleaning up after repairs</a>
                            </h3>
                            ...
                            <button type="button" class="btn btn-outline-dark position-relative z-2 mt-auto">Đặt ngay</button>
                        </div>
                    </div>
                </article>
            </div>
...
<!--                            <img src="/thesixhospital/assets/img/home/contractors/projects/05.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">-->
                        ...
                        <div class="col-sm-8 card-body d-flex flex-column align-items-start p-3 p-sm-4">
                            <h3 class="h6 mt-1 mt-sm-0 mb-2">
                                <a class="stretched-link hover-effect-underline" href="listings-contractors.html">Installation of flat roofs</a>
                            </h3>
                            <div class="d-flex align-items-center gap-3 mb-4">
                                <div class="d-flex align-items-center gap-1">
                                    <i class="fi-star-filled text-warning"></i>
...
<!--                            <img src="/thesixhospital/assets/img/home/contractors/projects/06.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">-->
                        ...
                        <div class="col-sm-8 card-body d-flex flex-column align-items-start p-3 p-sm-4">
                            <h3 class="h6 mt-1 mt-sm-0 mb-2">
                                <a class="stretched-link hover-effect-underline" href="listings-contractors.html">Handyperson for small projects</a>
                            </h3>
                            <div class="d-flex align-items-center gap-3 mb-4">
                                <div class="d-flex align-items-center gap-1">
                                    <i class="fi-star-filled text-warning"></i>
...
<!--                            <img src="/thesixhospital/assets/img/home/contractors/projects/07.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">-->
                        ...
                        <div class="col-sm-8 card-body d-flex flex-column align-items-start p-3 p-sm-4">
                            <h3 class="h6 mt-1 mt-sm-0 mb-2">
                                <a class="stretched-link hover-effect-underline" href="listings-contractors.html">One-time cleaning service</a>
                            </h3>
                            <div class="d-flex align-items-center gap-3 mb-4">
                                <div class="d-flex align-items-center gap-1">
                                    <i class="fi-star-filled text-warning"></i>
