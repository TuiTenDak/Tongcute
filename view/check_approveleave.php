            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <table class="table">
                        ...
                        <tbody>
                            <tr class="">
                                <td style="border: 2px solid #ffff;">Duyệt đơn nghỉ phép</td>
                            </tr>
                            <tr>
                                <table class='table' border='1'>
                                    ...
                                    <h4 class='card-title'>Thông tin chi tiết đơn duyệt</h4>
                                    <p class='card-text'><strong>Mã duyệt:</strong> 01 </p>
                                    <p class='card-text'><strong>Tên:</strong> Nguyễn Văn A </p>
                                    <p class='card-text'><strong>Email:</strong> user@gmail.com </p>
                                    <p class='card-text'><strong>Số điện thoại:</strong> 09123456789 </p>
                                    <p class='card-text'><strong>Giới tính:</strong> Nam </p>
                                    <p class='card-text'><strong>Ngày sinh:</strong> 01/01/1999 </p>
                                    <p class='card-text'><strong>Chức vụ:</strong> Bác sĩ dinh dưỡng </p>
                                    <p class='card-text'><strong>Mô tả:</strong> Xin phép nghỉ đi đám cưới </p>
                                    <div class="">
