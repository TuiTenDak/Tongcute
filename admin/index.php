            ...
            <div class="row">
                <div class="col-md-3 border-right" style="height: 100vh"   >
                    ...
                    <div class="list-group b4-bordor mt-3">
                        ...
                        <a href="../view/view_approveleave.php" class="list-group-item list-group-item-action">Duyêt đơn nghỉ phép</a>
                    </div>
                        ...
                        <tbody>
                            <tr class="">
                                <td style="border: 2px solid #ffff;">
                                    <a href="../view/add_personnel.php"><button id='btn-add' type='button' class='btn btn-outline-primary'>Thêm Nhân Viên</button></a>
                                </td>
                            </tr>
                            <tr>
                                <?php
